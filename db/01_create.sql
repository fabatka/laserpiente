...
values (1, E'Probablemente esté de mal humor.'),
       ...
       (37, E'No pienso que esté lloviendo.'),
       ...
       (44, E'¿No ves que está lloviendo?'),
...
values ('subjuntivo-probabilidad', 1, 2, 'estar', 'singular3'),
       ...
       ('subjuntivo-verbos_de_cabeza', 34, 4, 'viajar', 'plural3'),
       ('subjuntivo-verbos_de_cabeza', 35, 4, 'estar', 'singular1'),
       ('subjuntivo-verbos_de_cabeza', 36, 4, 'hacer', 'singular2'),
       ('subjuntivo-verbos_de_cabeza', 37, 4, 'estar', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 38, 6, 'haber', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 39, 7, 'estar', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 40, 8, 'hacer', 'singular2'),
       ('subjuntivo-verbos_de_cabeza', 41, 6, 'ser', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 42, 5, 'tener', 'plural2'),
       ('subjuntivo-verbos_de_cabeza', 43, 4, 'querer', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 44, 4, 'estar', 'singular3'),
       ('subjuntivo-verbos_de_cabeza', 45, 5, 'saber', 'singular1'),
       ('subjuntivo-verbos_de_cabeza', 46, 4, 'comprar', 'plural1'),
       ('subjuntivo-verbos_de_cabeza', 47, 5, 'estar', 'plural3'),
